...
public class TDefaultPath implements TPath {
    ...
    public Iterator<TPath> iterator() {
        ...
        // root.relativize(path)) die with a raw JS TypeError. Iterate the
        // name elements like the JDK: getName(0)..getName(count-1).
        var names = new java.util.ArrayList<TPath>();
    ...
    public boolean equals(Object obj) {
        // epubcheck-standalone shim: the stock file returned FALSE for
        // this == obj (an inverted identity check); TPath.relativize and the
        // file-walk machinery compare paths for equality and must see true.
        if (this == obj) {
            return true;
        }
