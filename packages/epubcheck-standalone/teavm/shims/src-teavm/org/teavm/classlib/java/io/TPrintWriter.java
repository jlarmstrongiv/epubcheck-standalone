...
public class TPrintWriter extends Writer {
    ...
    public TPrintWriter(java.io.File file, String csn) throws java.io.FileNotFoundException,
            java.io.UnsupportedEncodingException {
        this(new java.io.OutputStreamWriter(new java.io.FileOutputStream(file),
                java.nio.charset.Charset.forName(csn)), false);
    }
