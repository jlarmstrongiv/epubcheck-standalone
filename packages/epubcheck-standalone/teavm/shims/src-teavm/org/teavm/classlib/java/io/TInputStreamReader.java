...
public class TInputStreamReader extends TReader {
    ...
    public int read(char[] cbuf, int off, int len) throws IOException {
        ...
        // leaves maxNextCharInd unadvanced and ReadChar() serves stale buffer contents,
        // corrupting .rnc schema tokenization. Fix: never return 0 unless len == 0; keep
        // filling until at least one char is produced or return -1 at EOF.
        ...
        do {
            ...
            len -= sz;
            bytesRead += sz;
        } while (len > 0 && ensureBufferHasData(false) && outBuffer.hasRemaining());
