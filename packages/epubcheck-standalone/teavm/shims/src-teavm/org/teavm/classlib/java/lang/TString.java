...
public final class TString extends TObject implements TSerializable, TComparable<TString>, TCharSequence {
    ...
    public TString(byte[] ascii, int hibyte, int offset, int count) {
        this(buildHibyteChars(ascii, hibyte, offset, count));
    }

    private static char[] buildHibyteChars(byte[] ascii, int hibyte, int offset, int count) {
